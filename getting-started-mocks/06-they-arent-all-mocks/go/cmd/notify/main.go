...
import (
	...
	"github.com/speedscale/demo/getting-started-mocks/06-they-arent-all-mocks/go/notifier"
)
...
func main() {
	...
	n := notifier.New(notifier.HTTPShipmentStatus(baseURL), printSender, notifier.NewMemoryRecorder(), time.Sleep)
